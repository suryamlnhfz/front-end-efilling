...
function loadCharts() {
    (g = getChartColorsArray("line_chart_basic")) &&
        ((y = {
            series: [
                {
                    ...
                    data: [1000, 42211, 3225, 51111, 42329, 6112, 61119, 191, 111148],
                },
            ],
            chart: {
                height: 350,
            ...
            colors: g,
            title: {
                text: "Jumlah Siswa Yang Belum Lunas",
                align: "left",
    ...
    (g = getChartColorsArray("line_chart_basic_siswa")) &&
        ((y = {
            series: [
                {
                    name: "Pendapatan Perbulan",
        ...
        (g = getChartColorsArray("line_chart_datalabel")) &&
            ((y = {
                ...
                series: [
                    { name: "Total Pendapatan", data: [222, 1124, 3222, 11136, 22233, 1131, 11133] },
                    { name: "Total Tunggakan", data: [14222, 11111, 22216, 11112, 33317, 99913, 487612] },
                ],
                title: {
                    text: "Grafik Pendapatan Dan Tunggakan",
                    align: "left",
                    style: { fontWeight: 500 },
                },
                grid: {
                ...
                yaxis: { title: { text: "Nominal" }, min: 0, max: 100000 },
                legend: {
                    position: "top",
